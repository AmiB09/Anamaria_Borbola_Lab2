...
builder.Services.AddDbContext<LibraryIdentityContext>(options => options.UseSqlServer(builder.Configuration.GetConnectionString("Anamaria_Borbola_Lab2Context") ?? throw new InvalidOperationException("Connection string 'Anamaria_Borbola_Lab2Context' not found.")));
